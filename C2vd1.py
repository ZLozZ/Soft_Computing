...
y = float(input('Nhập giá trị y(0): '))
...
print("\nGiá trị khởi tạo của hàm f(x, y) là:", x**2 + y**2)
print("Giá trị của x và y tại điểm tối thiểu lúc khởi tạo là:", x, y)
...
for i in range(1, n): 
    ...
    print("Giá trị của x và y tại thời điểm đó là:", round(x,5), round(y,5))
...
print("Giá trị của x và y tại lần lặp thứ", save, "là:", round(min_x,5), round(min_y,5))
print("\n***********************************************************************************")
